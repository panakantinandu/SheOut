  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Two of these you can do yourself, in the app, under Profile, Privacy & Data. "Download my data" gives you a file of everything we hold about your account: your profile, trips, payments, the ratings you gave, and your support tickets. It includes other people on your trips only by the name you were shown. "Delete my account" closes your account at once and removes your name, phone number, saved addresses, emergency contacts, profile photo and identity documents - the photo and documents are deleted from storage, not hidden. Your messages are deleted, except on a trip with an open support dispute, where each is kept only as "[deleted]". Completed trips and payments stay for the retention period the law requires, showing you as "Deleted User". Your details can be corrected on your profile at any time.',
        `To make any other request, or to complain about how we handled your data, contact the grievance officer. Their email is shown in the app under Help & Support and under Profile, Privacy & Data. Name and response period: ${TODO_LEGAL}. Under Indian law you are entitled to a named person and a response within a defined period, and both belong here before launch.`,
      ],
    },
    {
      heading: 'Children',
